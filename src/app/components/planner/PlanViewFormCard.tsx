...
import { GroceryCategory, GroceryPriority, useGroceryStore } from '@/app/store/grocery-store'
...
const PlanViewFormCard = () => {
    const {addItem,error}=useGroceryStore(); 
    const [name,setName]=React.useState("");
    const [quantity,setQuantity]=React.useState("1");
    const [category,setCategory]=React.useState<GroceryCategory>("Produce");
    const [priority,setPriority]=React.useState<GroceryPriority>("medium");
...
export default PlanViewFormCard