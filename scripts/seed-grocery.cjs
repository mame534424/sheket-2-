...
const databaseUrl = "postgresql://neondb_owner:npg_Go7ZDPA5VKJy@ep-gentle-mode-antiiu34-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require";
